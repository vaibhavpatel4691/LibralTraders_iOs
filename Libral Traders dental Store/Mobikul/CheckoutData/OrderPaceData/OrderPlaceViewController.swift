    ...
    func appTheme() {
        if #available(iOS 12.0, *) {
            ...
            if self.traitCollection.userInterfaceStyle == .dark {
                continuShopping.setTitleColor(AppStaticColors.darkButtonTextColor, for: .normal)
                continuShopping.backgroundColor = AppStaticColors.darkButtonBackGroundColor
             ...
             UINavigationBar.appearance().titleTextAttributes = [NSAttributedString.Key.foregroundColor: AppStaticColors.darkItemTintColor]
                ...
                continuShopping.setTitleColor(AppStaticColors.buttonTextColor, for: .normal)
                continuShopping.backgroundColor = AppStaticColors.buttonBackGroundColor
...
//        })
    ...
    @IBAction func createAccountClicked(_ sender: Any) {
        ...
        viewController.orderId = self.orderIdSignup
