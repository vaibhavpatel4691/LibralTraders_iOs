...
//                proceedBtn.setTitleColor(UIColor.black, for: .normal)
    ...
    override func viewDidAppear(_ animated: Bool) {
        if emptyView == nil {
            ...
            if Defaults.customerToken != nil {
                ...
                emptyView.actionBtn.setTitle("Add Address Details".localized, for: .normal)
                emptyView.labelMessage.text = "Please add address details for checkout".localized
                emptyView.titleText.text = "Add Address Details".localized
            }
    ...
    func hitRequest() { 
        ...
        viewModel?.call = { [weak self] (check, data) in
            if check {
                self?.emptyLabel.text = data
