       ...
       // cell.setTrackProgress(progress: 0.75)
        ...
        cell.reOrderBtn.addTapGestureRecognizer {
            ...
            if cell.reOrderBtn.titleLabel?.text == "REORDER" {
                ...
                print("Cancel hooo.....")
                self.moveDelegate?.moveToAnother(id: self.myOrderCollectionModel[indexPath.row].orderId!, controller: .orderCancelVC)
            }
        }
...
//            self.myOrderCollectionModel[indexPath.row].isExpanded.toggle()
