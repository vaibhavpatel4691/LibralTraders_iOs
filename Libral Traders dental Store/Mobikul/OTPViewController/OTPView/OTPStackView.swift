...
class OTPStackView: UIStackView {
    ...
    //Colors
    let inactiveFieldBorderColor = UIColor.gray.withAlphaComponent(0.5)
   // let textBackgroundColor = UIColor(white: 1, alpha: 0.5)
    //let activeFieldBorderColor = Utilities.sharedInstance.hexStringToUIColor(hex: "0099FF")
    let activeFieldBorderColor = UIColor().hexToColor(hexString: "bdf977")
    ...
    private final func setupTextField(_ textField: OTPTextField){
       ...
       // textField.backgroundColor = textBackgroundColor
        ...
        //textField.font = UIFont(name: "Inter-Bold", size: 32)
