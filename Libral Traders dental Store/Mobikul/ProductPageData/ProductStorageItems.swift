...
struct ProductViewModalActionsItem: ProductViewModalItem {
 ...
 #if MARKETPLACE || BTOB || HYPERLOCAL
struct ProductViewModalReportItem: ProductViewModalItem {
    var type: ProductItemTyoe {
        return .report
    }
    var heading: String {
...
struct ProductViewModalShortDescriptionItem: ProductViewModalItem {
    ...
    init(shortDescription: String) {
        ...
        self.description = shortDescription.html2AttributedString ?? NSAttributedString()
    }
}

#if MARKETPLACE || BTOB
struct ProductViewModalSellerInfoItem: ProductViewModalItem {
    var type: ProductItemTyoe {
        return .sellerInfo
    }
    var heading: String {
