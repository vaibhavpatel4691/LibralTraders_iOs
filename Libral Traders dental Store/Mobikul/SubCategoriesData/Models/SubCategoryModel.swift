...
public struct SubCategoryModel {
    ...
    private struct SerializationKeys {
        ...
        static let tabCatgeoryBannerImage = "smallBannerImage"
    ...
    public var tabCategoryBannerImage =  [BannerImage]()
    ...
    public init(json: JSON) {
        ...
        if let items = json[SerializationKeys.tabCatgeoryBannerImage].array { tabCategoryBannerImage = items.map { BannerImage(json: $0) } }
