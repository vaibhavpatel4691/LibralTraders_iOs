...
//                downloadBtn.setTitleColor(UIColor.black, for: .normal)
                downloadBtn.backgroundColor = AppStaticColors.darkButtonBackGroundColor
                downloadBtn.setTitleColor(AppStaticColors.darkButtonTextColor, for: .normal)
                let image = UIImage(named: "sharp-download")?.withRenderingMode(.alwaysTemplate)
                downloadBtn.setImage(image, for: .normal)
                downloadBtn.tintColor = AppStaticColors.darkButtonTextColor


            } else {
                downloadBtn.backgroundColor = AppStaticColors.buttonBackGroundColor
                downloadBtn.setTitleColor(AppStaticColors.buttonTextColor, for: .normal)
                let image = UIImage(named: "sharp-download")?.withRenderingMode(.alwaysTemplate)
                downloadBtn.setImage(image, for: .normal)
                downloadBtn.tintColor = AppStaticColors.buttonTextColor
