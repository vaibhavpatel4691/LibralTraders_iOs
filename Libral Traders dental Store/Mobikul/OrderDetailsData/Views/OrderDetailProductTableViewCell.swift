    ...
    override func awakeFromNib() {
        ...
        if #available(iOS 12.0, *) {
            if self.traitCollection.userInterfaceStyle == .dark {
                writeAReviewBtn.backgroundColor = AppStaticColors.darkButtonBackGroundColor
                writeAReviewBtn.setTitleColor(AppStaticColors.darkButtonTextColor, for: .normal)
            } else {
                writeAReviewBtn.backgroundColor = AppStaticColors.buttonBackGroundColor
                writeAReviewBtn.setTitleColor(AppStaticColors.buttonTextColor, for: .normal)
            }
        } else {
            writeAReviewBtn.backgroundColor = AppStaticColors.buttonBackGroundColor
            writeAReviewBtn.setTitleColor(AppStaticColors.buttonTextColor, for: .normal)
