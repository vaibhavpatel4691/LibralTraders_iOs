    ...
    func appTheme() {
        if #available(iOS 12.0, *) {
            ...
            if self.traitCollection.userInterfaceStyle == .dark {
              ...
              settingsBtn.backgroundColor = AppStaticColors.darkButtonBackGroundColor
              settingsBtn.setTitleColor(AppStaticColors.darkButtonTextColor, for: .normal)
             ...
             settingsBtn.backgroundColor = AppStaticColors.buttonBackGroundColor
             settingsBtn.setTitleColor(AppStaticColors.buttonTextColor, for: .normal)
