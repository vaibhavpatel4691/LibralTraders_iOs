...
public struct TotalsData {
    ...
    // MARK: Properties
    public var unformattedValue: Float!
    ...
    public init(json: JSON) {
        if json[SerializationKeys.unformattedValue].float != nil {
            unformattedValue = json[SerializationKeys.unformattedValue].floatValue
