...
//    @IBOutlet weak var gridListLbl: UILabel!
    ...
    override func awakeFromNib() {
        ...
        if Defaults.language == "ar" {
            filterBtn.titleEdgeInsets = UIEdgeInsets(top: 0, left: 0, bottom: 0, right: 16)
            sortBtn.titleEdgeInsets = UIEdgeInsets(top: 0, left: 0, bottom: 0, right: 16)
            gridListBtn.titleEdgeInsets = UIEdgeInsets(top: 0, left: 0, bottom: 0, right: 16)
        }
    }
