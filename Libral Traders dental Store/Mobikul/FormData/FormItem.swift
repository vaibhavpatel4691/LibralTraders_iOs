...
class FormItem: FormValidable {
    ...
    init(multiDataValue: [Selection], placeholder: String, value: String? = nil) {
        self.placeholder = placeholder
        self.value = value
        multiData = multiDataValue
...
struct Selection {
    ...
    var id: String?
    var check: Bool?
    init(label: String, id: String, check: Bool) {
        self.label = label
        self.id = id
        self.check = check
    }
