            ...
            if let val = formItem.prifixData as? [String] {
                ...
                if #available(iOS 12.0, *) {
                    if self.traitCollection.userInterfaceStyle == .dark {
                        ...
                        gg?.titleTextAttributes = [NSAttributedString.Key.foregroundColor: AppStaticColors.darkItemTintColor]
                        gg?.toolbarBackgroundColor = AppStaticColors.darkPrimaryColor
                    } else {
                        gg?.titleTextAttributes = [NSAttributedString.Key.foregroundColor: AppStaticColors.itemTintColor]
                        gg?.toolbarBackgroundColor = AppStaticColors.primaryColor
                    }
                } else {
                    gg?.titleTextAttributes = [NSAttributedString.Key.foregroundColor: AppStaticColors.itemTintColor]
                    gg?.toolbarBackgroundColor = AppStaticColors.primaryColor
                ...
                //this is actually the title of toolbar
