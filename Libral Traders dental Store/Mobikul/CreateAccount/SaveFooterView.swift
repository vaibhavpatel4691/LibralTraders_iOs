    ...
    func theme() {
        if #available(iOS 12.0, *) {
            if self.traitCollection.userInterfaceStyle == .dark {
                self.createAccountBtn.backgroundColor = AppStaticColors.darkButtonBackGroundColor
                self.createAccountBtn.setTitleColor(AppStaticColors.darkButtonTextColor, for: .normal)
            } else {
                self.createAccountBtn.backgroundColor = AppStaticColors.buttonBackGroundColor
                self.createAccountBtn.setTitleColor(AppStaticColors.buttonTextColor, for: .normal)
            }
        } else {
            self.createAccountBtn.backgroundColor = AppStaticColors.buttonBackGroundColor
            self.createAccountBtn.setTitleColor(AppStaticColors.buttonTextColor, for: .normal)
